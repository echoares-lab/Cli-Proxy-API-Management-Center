...
# Agent Directives — `Cli-Proxy-API-Management-Center`

> **Generated from the Obsidian vault. Do not edit this region by hand** — run `dev-policies/tooling/scripts/render-agents-md.py --repo . --profile frontend-app`. Edits here are overwritten and CI fails on drift.
